...
WRITE(*,10)kf,m,q,x
WRITE(*,*)
IF (kf == 1) WRITE(*,*)' x(degs.)    cem(x,q)       cem''(X,Q)'
IF (kf == 2) WRITE(*,*)' x(degs.)    sem(x,q)       sem''(X,Q)'
WRITE(*,*)' --------------------------------------'
CALL mtu0(kf,m,q,x,csf,csd)
WRITE(*,20)x,csf,csd
10   FORMAT(1X,4HKF =,i2,',  ',3HM =,i2,',  ', 3HQ =,f5.1,',  ',3HX =,f5.1)
...
DOUBLE PRECISION, INTENT(OUT)            :: csf
DOUBLE PRECISION, INTENT(OUT)            :: csd
IMPLICIT DOUBLE PRECISION (a-h,o-z)
DIMENSION fg(251)
