...
!  call timestamp ( )
  ...
  write ( *, '(a)' ) '  Test problems for the QUADRULE library.'
  call test01
  call test02
  call test03
  call test04
...
!
  ...
  integer nfunc
  integer norder
  real ( kind = 8 ) result(maxfunc)
  real ( kind = 8 ) weight(maxorder)
  real ( kind = 8 ) xtab(maxorder)
!
  call func_set ( 'COUNT', nfunc )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  BASHFORTH_SET sets up Adams-Bashforth quadrature;'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Integration interval is [0,1].'
  ...
  do ilo = 1, nfunc, 5
    ...
    print *,'nfunc=',nfunc
    write ( *, '(a)' ) ' '
    write ( *, '(4x, 5a14 )' ) ( fname(i), i = ilo, ihi )
    write ( *, '(a)' ) ' '
    do norder = 1, maxorder
 
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call bashforth_set ( norder, xtab, weight )
 
        call summer ( func, norder, xtab, weight, result(i) )
 
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
  end do
  return
end
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call bdfc_set ( norder, weight, xtab )
 
        call bdf_sum ( func, norder, weight, xtab, diftab, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
  end do
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call bdfp_set ( norder, weight, xtab )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  CHEB_SET sets up Chebyshev quadrature;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  write ( *, '(a)' ) '  Quadrature order will vary.'
  write ( *, '(a)' ) '  Integrand will vary.'
  write ( *, '(a)' ) ' '
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      if ( norder /= 8 ) then
        do i = ilo, ihi
          call func_set ( 'SET', i )
          call cheb_set ( norder, xtab, weight )
          call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
            result(i) )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST05'
  write ( *, '(a)' ) '  CHEB_TC_SET sets up Gauss-Chebyshev quadrature,'
  write ( *, '(a)' ) '  ( closed, first kind );'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  Integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  write ( *, '(a)' ) '  Quadrature order will vary.'
  write ( *, '(a)' ) '  Integrand will vary.'
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 2, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call cheb_tc_set ( norder, xtab, weight )
        call summer ( func, norder, xtab, weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST06'
  write ( *, '(a)' ) '  CHEB_TO_SET sets up Gauss-Chebyshev quadrature,'
  write ( *, '(a)' ) '  ( open, first kind );'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  Integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      ...
      do i = ilo, ihi
        ...
        call func_set ( 'SET', i )
        call cheb_to_set ( norder, xtab, weight )
        call summer ( func, norder, xtab, weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST07'
  write ( *, '(a)' ) '  CHEB_U_SET sets up Gauss-Chebyshev quadrature;'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  Integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call cheb_u_set ( norder, xtab, weight )
        call summer ( func, norder, xtab, weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST08'
  write ( *, '(a)' ) '  HERMITE_COM computes a Gauss-Hermite rule;'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  The integration interval is ( -Infinity, +Infinity ).'
  do ilo = 1, nfunc, 5
    ihi = min ( ilo + 4, nfunc )
    write ( *, '(a)' ) ' '
    write ( *, '(4x, 5a14 )' ) ( fname(i), i = ilo, ihi )
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call hermite_com ( norder, xtab, weight )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST09'
  write ( *, '(a)' ) '  HERMITE_SET sets up Gauss-Hermite quadrature;'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  The integration interval is ( -Infinity, +Infinity ).'
  write ( *, '(a)' ) ' '
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call hermite_set ( norder, xtab, weight )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST10'
  write ( *, '(a)' ) '  JACOBI_COM sets up Gauss-Jacobi quadrature;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  write ( *, '(a)' ) '  Quadrature order will vary.'
  write ( *, '(a)' ) '  Integrand will vary.'
  write ( *, '(a)' ) ' '
  do k = 1, 2
    ...
    do ilo = 1, nfunc, 5
      ...
      do norder = 1, maxorder
        do i = ilo, ihi
          call func_set ( 'SET', i )
          call jacobi_com ( norder, xtab, weight, alpha, beta )
          call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
            result(i) )
        end do
        write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  implicit none
!
  integer, parameter :: norderg = 10
  integer, parameter :: norderk = 2 * norderg + 1
!
  real ( kind = 8 ), external :: fx2sd1
  real ( kind = 8 ) resultg
  real ( kind = 8 ) resultk
  real ( kind = 8 ) weightg(norderg)
  real ( kind = 8 ) weightk(norderk)
  real ( kind = 8 ) xtabg(norderg)
  real ( kind = 8 ) xtabk(norderk)
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST11'
  write ( *, '(a)' ) '  KRONROD_SET sets up Kronrod quadrature;'
  write ( *, '(a)' ) '  LEGENDRE_SET sets up Gauss-Legendre quadrature;'
  write ( *, '(a)' ) '  SUMMER_GK carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Integration interval is [-1, 1].'
  write ( *, '(a)' ) '  Integrand is X**2 / SQRT ( 1.1 - X**2 ).'
  write ( *, '(a)' ) ' '
  call legendre_set ( norderg, xtabg, weightg )
  call kronrod_set ( norderk, xtabk, weightk )
  call summer_gk ( fx2sd1, norderg, weightg, resultg, norderk, xtabk, &
    weightk, resultk )
  write ( *, '(i2,2x,g16.10)' ) norderg, resultg
  write ( *, '(i2,2x,g16.10)' ) norderk, resultk
  write ( *, '(2x,2x,g16.10)' )          resultg-resultk
  return
end
subroutine test12
!
...
!
  ...
  call legendre_set ( norderg, xtabg, weightg )
  call kronrod_set ( norderk, xtabk, weightk )
  call sum_sub_gk ( fx2sd1, a, b, nsub, norderg, weightg, resultg, &
    norderk, xtabk, weightk, resultk, error )
  write ( *, '(i2,2x,g16.10)' ) norderg, resultg
  write ( *, '(i2,2x,g16.10)' ) norderk, resultk
  write ( *, '(2x,2x,g16.10)' )          error
  return
end
subroutine test13
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST13'
  write ( *, '(a)' ) '  LAGUERRE_COM computes a Gauss-Laguerre rule;'
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call laguerre_com ( norder, xtab, weight, alpha )
 
        call laguerre_sum ( func, a, norder, xtab, weight, result(i) )
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, 10
      ...
      write ( *, '(i2,2x,5g14.6)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST17'
  write ( *, '(a)' ) '  LAGUERRE_SET sets up Gauss-Laguerre quadrature;'
  write ( *, '(a)' ) '  LAGUERRE_SUM carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,g14.6,a)' ) '  The integration interval is [ ', &
    a, ', +Infinity ).'
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call laguerre_set ( norder, xtab, weight )
...
!
  implicit none
!
  integer, parameter :: norder = 19
!
  integer i
  integer iwdifmax
  integer ixdifmax
  real ( kind = 8 ) wdifmax
  real ( kind = 8 ) weight1(norder)
  real ( kind = 8 ) weight2(norder)
  real ( kind = 8 ) xdifmax
  real ( kind = 8 ) xtab1(norder)
  real ( kind = 8 ) xtab2(norder)
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST16'
  write ( *, '(a)' ) '  LEGENDRE_COM computes Gauss-Legendre data;'
  write ( *, '(a)' ) '  LEGENDRE_SET looks up the same data.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i6)' ) '  Compare the data for NORDER = ', norder
  call legendre_com ( norder, xtab1, weight1 )
  call legendre_set ( norder, xtab2, weight2 )
  ...
  iwdifmax = 0
  do i = 1, norder
    if ( abs ( xtab1(i) - xtab2(i) ) > xdifmax ) then
      xdifmax = abs ( xtab1(i) - xtab2(i) )
      ixdifmax = i
    end if
    if ( abs ( weight1(i) - weight2(i) ) > wdifmax ) then
  ...
  if ( ixdifmax /= 0 ) then
    ...
    write ( *, '(a,i6)' ) '  for index I = ', ixdifmax
  ...
  if ( iwdifmax /= 0 ) then
    ...
    write ( *, '(a,i6)' ) '  for index I = ', iwdifmax
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST19'
  write ( *, '(a)' ) '  LEGENDRE_COM computes a Gauss-Legendre rule;'
  write ( *, '(a)' ) '  SUM_SUB carries it out over subintervals.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Here, we use a fixed order NORDER = ', norder
  write ( *, '(a)' ) '  and use more and more subintervals.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  NSUB     Integral'
  write ( *, '(a)' ) ' '
 
  call legendre_com ( norder, xtab, weight )
 
  do iexp = 0, 9
    nsub = 2**iexp
    call sum_sub ( fx2sd1, a, b, nsub, norder, xlo, xhi, xtab, weight, result )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST20'
  write ( *, '(a)' ) '  LEGENDRE_COM sets up Gauss-Legendre quadrature;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        ...
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, &
          weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
...
!
  ...
  real ( kind = 8 ) weight1(norder)
  real ( kind = 8 ) weight2(norder)
  real ( kind = 8 ) weight3(norder)
  real ( kind = 8 ) xtab1(norder)
  real ( kind = 8 ) xtab2(norder)
  real ( kind = 8 ) xtab3(norder)
!
  a = -1.0D+00
  b = +1.0D+00
  c =  0.0D+00
  ...
  write ( *, '(a)' ) '  LEGENDRE_SET_X0_01 sets up Gauss-Legendre quadrature'
  ...
  write ( *, '(a)' ) '  and compare the results of LEGENDRE_SET_X0_01.'
  write ( *, '(a)' ) ' '
  ...
  call legendre_set_x0_01 ( norder, xtab3, weight3 )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Abscissas:'
  write ( *, '(a)' ) ' '
  ...
  write ( *, '(a)' ) ' '
  do i = 1, norder
    write ( *, '(i2,3f16.12)' ) i, xtab1(i), xtab2(i), xtab3(i)
  end do
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Weights:'
  write ( *, '(a)' ) ' '
  ...
  write ( *, '(a)' ) ' '
  do i = 1, norder
    write ( *, '(i2,3f16.12)' ) i, weight1(i), weight2(i), weight3(i)
  end do
  return
end
subroutine test23
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST23'
  write ( *, '(a)' ) '  LEGENDRE_SET_COS sets up Gauss-Legendre quadrature'
  ...
  do ilo = 1, nfunc, 5
    ...
    do iexp = 0, 4
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_cos ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, &
          weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST235'
  write ( *, '(a)' ) '  LEGENDRE_SET_SQRTX_01 sets up Gauss-Legendre quadrature'
  ...
  do ilo = 1, nfunc, 5
    ...
    do iexp = 0, 3
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_sqrtx_01 ( norder, xtab, weight )
        call summer ( func, norder, xtab, weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST236'
  write ( *, '(a)' ) '  LEGENDRE_SET_SQRTX2_01 sets up Gauss-Legendre'
  write ( *, '(a)' ) '    quadrature over [0,1] with weight function 1/SQRT(X);'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do iexp = 0, 3
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_sqrtx2_01 ( norder, xtab, weight )
        call summer ( func, norder, xtab, weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
    end do
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST24'
  write ( *, '(a)' ) '  LEGENDRE_SET_COS2 sets up Gauss-Legendre quadrature'
  ...
  do ilo = 1, nfunc, 5
    ...
    do iexp = 1, 4
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_cos2 ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, &
          weight, result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  integer nfunc
  integer norder
  integer, dimension ( ntest ) :: norder_test = (/ 1, 2, 3, 4, 5, 6, 7, 8, 16 /)
  integer nsub
  real ( kind = 8 ) result(maxfunc)
  real ( kind = 8 ) weight(maxorder)
  real ( kind = 8 ) xhi
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST25'
  write ( *, '(a)' ) '  LEGENDRE_SET_LOG sets up Gauss-Legendre quadrature'
  write ( *, '(a)' ) '    over [0,1] with weight function -LOG(X);'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    write ( *, '(a)' ) ' '
    do itest = 1, ntest
      norder = norder_test(itest)
 
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_log ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder,  xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_x0_01 ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST27'
  write ( *, '(a)' ) '  LEGENDRE_SET_X1 sets up Gauss-Legendre quadrature'
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_x1 ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) '    for integrating ( 1 + X ) * F(X) over [-1,1];'
  write ( *, '(a)' ) '  RULE_ADJUST adjusts a rule for a new interval.'
  write ( *, '(a)' ) '  LEGENDRE_SET_X1_01 sets up Gauss-Legendre quadrature'
  write ( *, '(a)' ) '    for integrating X * F(X) over [0,1];'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  We will use LEGENDRE_SET_X1 to get a rule for [-1,1],'
  write ( *, '(a)' ) '  adjust it to [0,1] using RULE_ADJUST,'
  write ( *, '(a)' ) '  make further adjustments because the weight function'
  write ( *, '(a)' ) '  is not 1, '
  write ( *, '(a)' ) '  and compare the results of LEGENDRE_SET_X1_01.'
  write ( *, '(a)' ) ' '
...
!
  ...
  call legendre_set_x1_01 ( norder, xtab3, weight3 )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Abscissas:'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Original        Adjusted         Stored'
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_x1_01 ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST30'
  write ( *, '(a)' ) '  LEGENDRE_SET_X2 sets up Gauss-Legendre quadrature'
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_x2 ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) '    for integrating ( 1 + X )^2 * F(X) over [-1,1];'
  write ( *, '(a)' ) '  RULE_ADJUST adjusts a rule for a new interval.'
  write ( *, '(a)' ) '  LEGENDRE_SET_X2_01 sets up Gauss-Legendre quadrature'
  write ( *, '(a)' ) '    for integrating X^2 * F(X) over [0,1];'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  We will use LEGENDRE_SET_X2 to get a rule for [-1,1],'
  write ( *, '(a)' ) '  adjust it to [0,1] using RULE_ADJUST,'
  write ( *, '(a)' ) '  make further adjustments because the weight function'
  write ( *, '(a)' ) '  is not 1, '
  write ( *, '(a)' ) '  and compare the results of LEGENDRE_SET_X2_01.'
  write ( *, '(a)' ) ' '
  call legendre_set_x2 ( norder, xtab1, weight1 )
  xtab2(1:norder) = xtab1(1:norder)
  weight2(1:norder) = weight1(1:norder)
  call rule_adjust ( a, b, c, d, norder, xtab2, weight2 )
!
...
!
  ...
  call legendre_set_x2_01 ( norder, xtab3, weight3 )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Abscissas:'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Original  Adjusted Stored'
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call legendre_set_x2_01 ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST33'
  write ( *, '(a)' ) '  LOBATTO_SET sets up Lobatto quadrature;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  Integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 2, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call lobatto_set ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST34'
  write ( *, '(a)' ) '  MOULTON_SET sets up Adams-Moulton quadrature;'
  write ( *, '(a)' ) '  SUMMER carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Integration interval is [0,1].'
  write ( *, '(a)' ) '  Quadrature order will vary.'
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call moulton_set ( norder, xtab, weight )
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 2, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call ncc_set ( norder, xtab, weight )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST36'
  write ( *, '(a)' ) '  NCC_COM computes a closed Newton Cotes rule;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  Integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 2, maxorder
      ...
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call ncc_com ( norder, xtab, weight )
...
!
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      ...
      if ( norder <= 7 .or. norder == 9 ) then
        do i = ilo, ihi
          call func_set ( 'SET', i )
          call nco_set ( norder, xtab, weight )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST38'
  write ( *, '(a)' ) '  NCO_COM sets up an open Newton-Cotes rule;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  Integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      ...
      if ( norder <= 7 .or. norder == 9 ) then
        do i = ilo, ihi
          call func_set ( 'SET', i )
          call nco_com ( norder, xtab, weight )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST39'
  write ( *, '(a)' ) '  RADAU_SET sets up Radau quadrature;'
  write ( *, '(a)' ) '  SUM_SUB carries it out.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,2g14.6)' ) '  The integration interval is ', a, b
  write ( *, '(a,i6)' ) '  Number of subintervals is ', nsub
  ...
  do ilo = 1, nfunc, 5
    ...
    do norder = 1, maxorder
      do i = ilo, ihi
        call func_set ( 'SET', i )
        call radau_set ( norder, xtab, weight )
        call sum_sub ( func, a, b, nsub, norder, xlo, xhi, xtab, weight, &
          result(i) )
      end do
      write ( *, '(i2,2x,5f14.8)' ) norder, result(ilo:ihi)
...
!
!    Output, double precision F1SD1, the value of the function.
!
  implicit none
!
  real ( kind = 8 ) f1sd1
...
!    Input, double precision X, the argument of the function.
!
!    Output, double precision FXSD1, the value of the function.
!
  implicit none
!
  real ( kind = 8 ) fxsd1
...
!    Input, double precision X, the argument of the function.
!
!    Output, double precision FX2SD1, the value of the function.
!
  implicit none
!
  real ( kind = 8 ) fx2sd1
...
!    Input, double precision X, the argument of the function.
!
!    Output, double precision FUNC, the value of the function.
!
  implicit none
!
  real ( kind = 8 ) func
...
!
  ...
  weight(1:norder) = 2.0D+00 / real ( norder, kind = 8 )
  return
end
...
!
  ...
  real ( kind = 8 ) xtab(norder)
  do i = 1, norder
    angle = real ( 2 * i - 1, kind = 8 ) * d_pi ( ) &
          / real ( 2 * norder, kind = 8 )
    xtab(i) = cos ( angle )
  end do
  weight(1:norder) = d_pi ( ) / real ( norder, kind = 8 )
  return
end
...
!
  ...
  do i = 1, norder
    angle = real (      i - 1, kind = 8 ) * d_pi ( ) &
          / real ( norder - 1, kind = 8 )
    xtab(i) = cos ( angle )
  end do
  weight(1) = d_pi ( ) / real ( 2 * ( norder - 1 ), kind = 8 )
  weight(2:norder-1) = d_pi ( ) / real ( norder - 1, kind = 8 )
  weight(norder) = d_pi ( ) / real ( 2 * ( norder - 1 ), kind = 8 )
  return
end
...
!
  ...
  real ( kind = 8 ) xtab(norder)
  do i = 1, norder
    angle = real ( i, kind = 8 ) * d_pi ( ) / real ( norder + 1, kind = 8 )
    xtab(i) = cos ( angle )
    weight(i) = d_pi ( ) * ( sin ( angle ) )**2 / real ( norder + 1, kind = 8 )
  end do
  return
end
...
!
  ...
  real ( kind = 8 ) x
  real ( kind = 8 ) xtab(norder)
  cc = 1.7724538509D+00 * gamma ( real ( norder, kind = 8 ) ) &
    / ( 2.0D+00**( norder - 1 ) )
  s = ( 2.0D+00 * real ( norder, kind = 8 ) + 1.0D+00 )**( 1.0D+00 / 6.0D+00 )
  do i = 1, ( norder + 1 ) / 2
    if ( i == 1 ) then
      x = s**3 - 1.85575D+00 / s
    else if ( i == 2 ) then
      x = x - 1.14D+00 * ( ( real ( norder, kind = 8 ) )**0.426D+00 ) / x
    else if ( i == 3 ) then
...
!
  ...
  do i = 1, norder
    if ( i == 1 ) then
      an = alpha / real ( norder, kind = 8 )
      bn = beta / real ( norder, kind = 8 )
      r1 = ( 1.0D+00 + alpha ) &
        * ( 2.78D+00 / ( 4.0D+00+ real ( norder**2, kind = 8 ) ) &
        + 0.768D+00 * an / real ( norder, kind = 8 ) )
      ...
      r2 = 1.0D+00 + 0.06D+00 * ( real ( norder, kind = 8 ) - 8.0D+00 ) * &
        ( 1.0D+00 + 0.12D+00 * alpha ) / real ( norder, kind = 8 )
      r3 = 1.0D+00 + 0.012D+00 * beta * &
        ( 1.0D+00 + 0.25D+00 * abs ( alpha ) ) / real ( norder, kind = 8 )
      x = x - r1 * r2 * r3 * ( 1.0D+00 - x )
    else if ( i == 3 ) then
      r1 = ( 1.67D+00 + 0.28D+00 * alpha ) / ( 1.0D+00 + 0.37D+00 * alpha )
      r2 = 1.0D+00 + 0.22D+00 * ( real ( norder, kind = 8 ) - 8.0D+00 ) &
        / real ( norder, kind = 8 )
      r3 = 1.0D+00 + 8.0D+00 * beta / &
        ( ( 6.28D+00 + beta ) * real ( norder**2, kind = 8 ) )
...
!
    if ( i == 1 ) then
      x = ( 1.0D+00 + alpha ) * ( 3.0D+00+ 0.92 * alpha ) / &
        ( 1.0D+00 + 2.4D+00 * real ( norder, kind = 8 ) + 1.8D+00 * alpha )
    else if ( i == 2 ) then
      x = x + ( 15.0D+00 + 6.25D+00 * alpha ) / &
        ( 1.0D+00 + 0.9D+00 * alpha + 2.5D+00 * real ( norder, kind = 8 ) )
    else
...
!
  ...
  integer norder2
  real ( kind = 8 ) xtab(norder)
  real ( kind = 8 ) xtab2(2*norder+1)
  real ( kind = 8 ) weight(norder)
  real ( kind = 8 ) weight2(2*norder+1)
  norder2 = 2 * norder + 1
...
!
  ...
  do
    k = k + 1
    if ( 6.0D+00 < x2 + real ( k, kind = 8 ) ) then
      exit
    end if
  end do
  z = x2 + real ( k, kind = 8 )
  y = ( z - 0.5D+00 ) * log ( z ) - z + 0.9189385332047D+00 + &
       ( ( ( ( ( &
       - 4146.0D+00 / z**2 &
       + 1820.0D+00 ) / z**2 &
       - 1287.0D+00 ) / z**2 &
...
!  right endpoints.
!
    yvala = diftab(norder) / real ( norder, kind = 8 )
    do j = norder-1, 1, -1
      yvala = yvala * a + diftab(j) / real ( j, kind = 8 )
    end do
    yvala = yvala * a
    yvalb = diftab(norder) / real ( norder, kind = 8 )
    do j = norder-1, 1, -1
      yvalb = yvalb * b + diftab(j) / real ( j, kind = 8 )
    end do
    yvalb = yvalb * b
...
!
  do i = 1, norder
    xtab(i) = real ( 2 * i - 1 - norder, kind = 8 ) &
            / real ( norder - 1, kind = 8 )
  end do
  return
end
...
!
  do i = 1, norder
    xtab(i) = real ( 2 * i - norder - 1, kind = 8 ) &
            / real ( norder + 1, kind = 8 )
  end do
  return
end
...
!
  ...
  real ( kind = 8 ) c
  real ( kind = 8 ) d
  real ( kind = 8 ) w(norder)
  real ( kind = 8 ) x(norder)
...
!
  ...
  do j = 1, nsub
    xmid = a + 0.5D0 * h * real ( 2 * j - 1, kind = 8 )
    partg = 0.0D+00
    partk = 0.0D+00
    do i = 1, norderk
