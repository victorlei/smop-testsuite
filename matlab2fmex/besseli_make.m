function [modlist,funlist,fun_info]=besseli_make(typestrlist)
...
for i=1:length(typestrlist)
 ...
 [modlist,funlist,len]=makeheader('besseli',1,typestr,modlist,funlist,r); 
...
%  end
 ...
 kernel=[kernel,'             call zbesi(real(mat2(1,1)),aimag(mat2(1,1)),',r];
 ...
 kernel=[kernel,'     &                   -mat1(1,1),dim,1,a,b,info,ierr)',r];
 kernel=[kernel,'            out(1,i)=out(1,i)+cmplx(a,b)*sin(-mat1(1,1)*pi)*2/pi',r];
 kernel=[kernel,'             endif',r];
 ...
 kernel=[kernel,'             if (mat1(1,1)>=0) then',r];
 kernel=[kernel,'              call zbesi(real(mat2(i,1)),aimag(mat2(i,1)),',r];
 kernel=[kernel,'     &                   mat1(1,1),dim,1,a,b,info,ierr)',r];
 ...
 kernel=[kernel,'     &                   -mat1(1,1),dim,1,a,b,info,ierr)',r];
 kernel=[kernel,'            out(i,1)=out(i,1)+cmplx(a,b)*sin(-mat1(1,1)*pi)*2/pi',r];
 kernel=[kernel,'             endif',r];
 kernel=[kernel,'            enddo',r];
 ...
 kernel=[kernel,'              if (mat1(1,1)>=0) then',r];
 kernel=[kernel,'               call zbesi(real(mat2(i,j)),aimag(mat2(i,j)),',r];
 kernel=[kernel,'     &                    mat1(1,1),dim,1,a,b,info,ierr)',r];
 ...
 kernel=[kernel,'     &                    -mat1(1,1),dim,1,a,b,info,ierr)',r];
 kernel=[kernel,'            out(i,j)=out(i,j)+cmplx(a,b)*sin(-mat1(1,1)*pi)*2/pi',r];
 kernel=[kernel,'              endif',r];
 kernel=[kernel,'             enddo',r];
 kernel=[kernel,'            enddo',r];
 kernel=[kernel,'           endif',r];
 ...
 kernel=[kernel,'             do j=1,in_2_n',r];
 kernel=[kernel,'              if (mat1(i,1)>=0) then',r];
 kernel=[kernel,'               call zbesi(real(mat2(1,j)),aimag(mat2(1,j)),',r];
 kernel=[kernel,'     &                    mat1(i,1),dim,1,a,b,info,ierr)',r];
 kernel=[kernel,'               out(i,j)=cmplx(a,b)',r];
 kernel=[kernel,'              else',r];
 kernel=[kernel,'               call zbesi(real(mat2(1,j)),aimag(mat2(1,j)),',r];
