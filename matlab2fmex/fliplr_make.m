function [modlist,funlist,fun_info]=fliplr_make(typestrlist)
...
for i=1:length(typestrlist)
 ...
 [modlist,funlist,len]=makeheader('fliplr',2,typestr,modlist,funlist,r); 
 ...
 kernel='';
 if any(strcmp(typestr,arr))
  kernel=[kernel,'        out=in_1(:,in_1_n:1:-1)',r];
 else
